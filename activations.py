...
class XIELUActivation(nn.Module):
    ...
    def __init__(
        ...
        try:
            ...
            print("CUDA-fused xIELU not available (%s) – falling back to a Python version.\n")
    ...
    def _xielu_cuda(self, x: Tensor) -> Tensor:
        ...
        if original_shape != x.shape:
            print("Warning: xIELU input tensor expects 3 dimensions but got (shape: %s). Reshaping to (shape: %s).")
